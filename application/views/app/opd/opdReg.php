                    	 ...
                    	 <div class="box">
                        	...
                        	<div class="box-body table-responsive">
                                ...
                                <tr>
                                	...
                                	<td width="79%"><textarea name="allergies" id="allergies" class="form-control input-sm" style="width: 60%;" rows="3"><?php echo $patientHistory->allergies?></textarea></td>
                                </tr>
                                <tr>
                                	<td valign="top">Warnings</td>
                                	<td><textarea name="warnings" id="warnings" class="form-control input-sm" style="width: 60%;" rows="3"><?php echo $patientHistory->warnings?></textarea></td>
                                </tr>
                                <tr>
                                	<td valign="top">Social History</td>
                                	<td><textarea name="social_history" id="social_history" class="form-control input-sm" style="width: 60%;" rows="3"><?php echo $patientHistory->social_history?></textarea></td>
                                </tr>
                                <tr>
                                	<td valign="top">Family History</td>
                                	<td><textarea name="family_history" id="family_history" class="form-control input-sm" style="width: 60%;" rows="3"><?php echo $patientHistory->family_history?></textarea></td>
                                </tr>
                                <tr>
                                	<td valign="top">Personal History</td>
                                	<td><textarea name="personal_history" id="personal_history" class="form-control input-sm" style="width: 60%;" rows="3"><?php echo $patientHistory->personal_history?></textarea></td>
                                </tr>
                                <tr>
                                	<td valign="top">Past Medical History</td>
                                	<td><textarea name="past_medical_history" id="past_medical_history" class="form-control input-sm" style="width: 60%;" rows="3"><?php echo $patientHistory->past_medical_history?></textarea></td>
                                </tr>
                                        </table>
                                        </div>
