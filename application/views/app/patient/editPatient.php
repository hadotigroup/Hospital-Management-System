                                            ...
                                            <div class="tab-content">
                                            	...
                                            	<div class="tab-pane active" id="tab_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <?php echo form_input('birthday',set_value('birthday',$patientInfo->birthday),'id="birthday" class="form-control input-sm" placeholder="Birthday" style="width: 150px;" required');?> 
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td>Birth Place</td>
