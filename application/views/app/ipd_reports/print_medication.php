...
<tr style="border-bottom:1px #999 solid">
	...
	<th style="border-bottom:1px #999 solid">Instruction</th>
	<th style="border-bottom:1px #999 solid">Advice</th>
	<th style="border-bottom:1px #999 solid">Days</th>
...
<tr>
												<td><?php echo date("M d, Y h:i:s A",strtotime($rows->dDate));?></td>
                                                ...
                                                <td align="center"><?php echo $rows->total_qty?></td>
